const CACHE="fafatraining-v98-0";
const CORE=["./","./index.html","./styles/fafatraining-v98.css","./src/fafatraining-coach-v98.js","./data/exercises-v98.json","./data/templates-v98.json","./manifest.json","./assets/logo/logo-fafatraining-header.jpg"];
