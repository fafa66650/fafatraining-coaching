const CACHE="fafatraining-v96-0";
const CORE=["./","./index.html","./styles/fafatraining-v96.css","./src/fafatraining-coach-v96.js","./data/exercises-v96.json","./data/templates-v96.json","./manifest.json","./assets/logo/logo-fafatraining-header.jpg"];
