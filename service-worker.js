...
const CACHE='fafatraining-elite-coach-v8';
const ASSETS=['./','./index.html','./style.css','./app.js','./data/exercises.json','./data/program_templates.json','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
